...
import org.podval.tools.util.Scala212Collections.{arrayMap, writeStrings, arrayZipForAll}
...
object TaskDefs:
  ...
  def toString(taskDef: TaskDef): String =
    ...
    val selectors: String = writeStrings(arrayMap(taskDef.selectors, _.toString), ", ")
