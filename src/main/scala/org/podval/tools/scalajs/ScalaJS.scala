...
import org.podval.tools.scalajs.dependencies.{Scala2Dependency, Scala3Dependency}

object ScalaJS:
  val group: String = "org.scala-js"
  val versionDefault: String = "1.10.0"

  // Note: no Scala 3 flavour exists
  ...
  object Compiler extends Scala2Dependency(group = group, nameBase = "scalajs-compiler")
