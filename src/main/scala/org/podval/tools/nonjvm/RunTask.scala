...
import org.podval.tools.gradle.{TaskWithDependency, TaskWithRunner}
import org.podval.tools.test.task.TestTask
import scala.reflect.ClassTag

trait RunTask[B <: NonJvmBackend, L <: LinkTask[B] : ClassTag] extends BackendTask[B] with TaskWithDependency[L]:
