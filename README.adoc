...
_https://github.com/scala-js/scala-js-website/pull/658[website 658]_;

- https://github.com/gmkumar2005/scala-js-env-playwright[Playwright Scala.js]:
https://github.com/gmkumar2005/scala-js-env-playwright/issues/17[17];

- https://scala-native.org[Scala Native:]
_https://github.com/scala-native/scala-native/pull/4320[4320]_,
https://github.com/scala-native/scala-native/issues/4323[4323],
_https://github.com/scala-native/scala-native/pull/4342[4342]_,
https://github.com/scala-native/scala-native/issues/4370[4370],
_https://github.com/scala-native/scala-native/pull/4371[4371]_,
https://github.com/scala-native/scala-native/issues/4372[4372];

- https://github.com/gradle/gradle[Gradle]:
_https://github.com/gradle/gradle/pull/32656[32656]_,
https://github.com/gradle/gradle/issues/32666[32666];
...
ZIO Test's treatment of
https://github.com/zio/zio/pull/9680[test wildcards]
and
https://github.com/zio/zio/pull/9756[test name matching],
and for accepting my fix to
https://github.com/zio/zio/pull/9979[emit sbt testing events on Scala.js and Scala Native];
- https://github.com/hearnadam[hearnadam]
for approving my fix to ZIO Test's
https://github.com/zio/zio/pull/9756[test name matching]
and merging my fix
https://github.com/zio/zio/pull/9756[match tests on both short and prefixed names];
- https://github.com/sjrd[sjrd]
for working with me on fixing issues with
JUnit4 for Scala.js reporting of
...
for accepting my fix to a https://github.com/scala-native/scala-native/pull/4342[spurious dependency] issue,
and for https://github.com/scala-native/scala-native/pull/4371/files[mentioning]
my plugin on the Scala Native website;
