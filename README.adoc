...
:attribute-scalajsModeProperty: org.podval.tools.scalajs.mode
:attribute-maiflaiProperty: com.github.maiflai.gradle-scalatest.mode
:attribute-mixedModeName: Mixed
// INCLUDED ATTRIBUTES
...
----
{attribute-scalajsModeProperty}=JVM
----
