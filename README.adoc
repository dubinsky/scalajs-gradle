...
|Parallel Collections: Linker uses it but does not bring it in
...
----
dependencies {
  scalajs 'io.github.gmkumar2005:scala-js-env-playwright_2.12:{version-scala-js-env-playwright}'
}
----
