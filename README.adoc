...
:icons: font
// INCLUDED ATTRIBUTES
:version-plugin: 0.9.14
:version-gradle: 9.2.0
:version-scala: 3.7.3
:version-scala-213: 2.13.17
...
:version-framework-airspec: 2025.1.21
...
:version-framework-zio-test: 2.1.22
:attribute-pluginScalaBackendProperty: org.podval.tools.backend
:attribute-gradleVersionForBadge: 9.2.0
// INCLUDED ATTRIBUTES
