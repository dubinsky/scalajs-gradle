...
:version-framework-specs2: 5.6.2
...
- test filtering: works when individual test case names are used,
...
- https://github.com/tgodzik[tgodzik] for accepting my fix to MUnit's
