...
:attribute-pluginBuildPerScalaVersionProperty: org.podval.tools.scalaplugin.buildPerScalaVersion
// INCLUDED ATTRIBUTES
...
link:src/main/scala/org/podval/tools/scalaplugin/scalajs/ScalaJSLinkMainTask.scala[org.podval.tools.scalaplugin.scalajs.ScalaJSLinkMainTask];
...
link:src/main/scala/org/podval/tools/scalaplugin/scalajs/ScalaJSLinkTestTask.scala[org.podval.tools.scalaplugin.scalajs.ScalaJSLinkTestTask];
...
link:src/main/scala/org/podval/tools/scalaplugin/scalajs/ScalaJSRunMainTask.scala[org.podval.tools.scalaplugin.scalajs.ScalaJSRunMainTask]
...
If no Node.js modules to install are listed, plugin installs the `jsdom` module,
...
For linking of the main code, plugin adds `link` task of type
link:src/main/scala/org/podval/tools/scalaplugin/scalanative/ScalaNativeLinkMainTask.scala[org.podval.tools.scalaplugin.scalanative.ScalaNativeLinkMainTask];
all tasks of this type automatically depend on the `classes` task.

For linking of the test code, plugin adds `testLink` task of type
link:src/main/scala/org/podval/tools/scalaplugin/scalanative/ScalaNativeLinkTestTask.scala[org.podval.tools.scalaplugin.scalanative.ScalaNativeLinkTestTask];
all tasks of this type automatically depend on the `testClasses` task.
...
Additional tasks of type
link:src/main/scala/org/podval/tools/scalaplugin/scalanative/ScalaNativeRunMainTask.scala[org.podval.tools.scalaplugin.scalanative.ScalaNativeRunMainTask]
can be added manually;
...
link:src/main/scala/org/podval/tools/scalaplugin/jvm/JvmTestTask.scala[org.podval.tools.scalaplugin.jvm.JvmTestTask].
...
link:src/main/scala/org/podval/tools/scalaplugin/scalajs/ScalaJSTestTask.scala[org.podval.tools.scalaplugin.scalajs.ScalaJSTestTask].
Such test tasks have to depend on a
`org.podval.tools.scalaplugin.scalajs.ScalaJSLinkTestTask task`.
...
link:src/main/scala/org/podval/tools/scalaplugin/scalanative/ScalaNativeTestTask.scala[org.podval.tools.scalaplugin.scalanative.ScalaNativeTestTask].
Such test tasks have to depend on a
`org.podval.tools.scalaplugin.scalanative.ScalaNativeLinkTestTask task`.
The `test` task added by the plugin does it automatically;
for manually added tasks this dependency has to be added manually.
...
- include sources specific to the Scala version used;
- expose data about backedn and Scala version via an extension;
