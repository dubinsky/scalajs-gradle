...
- property `{attribute-scalajsScalaBackendProperty}` is _not_ set for the project, and
...
<2> for Scala 2.13: `'{version-scala213-suffix}'`
...
final String scalaVersion        = '{version-scala}' // <1>
final String scalaVersionSuffix  = '3' // <2>
final String scala2versionSuffix = '{version-scala213-suffix}'
...
dependencies {
  // Plugin adds:
  scalajs "org.scala-js:scalajs-linker_$scala2versionSuffix:$scalaJsVersion"
  scalajs "org.scala-js:scalajs-sbt-test-adapter_$scala2versionSuffix:$scalaJsVersion"
  scalajs "org.scala-js:scalajs-env-jsdom-nodejs_$scala2versionSuffix:{version-scalajs-env-jsdom-nodejs}"

  scalaCompilerPlugins "org.scala-js:scalajs-compiler_$scalaVersion:$scalaJsVersion" // <4>
  testScalaCompilerPlugins "org.scala-js:scalajs-junit-test-plugin_$scalaVersion:$scalaJsVersion" // <5>

  implementation "org.scala-lang:scala3-library_sjs1_$scalaVersionSuffix:$scalaVersion" // <6>
  implementation "org.scala-js:scalajs-library_$scala2versionSuffix:$scalaJsVersion"
  implementation "org.scala-js:scalajs-dom_sjs1_$scalaVersionSuffix:{version-scalajs-dom}"

  testRuntimeOnly "org.scala-js:scalajs-test-bridge_$scala2versionSuffix:$scalaJsVersion"

  // Test framework(s) you use:
  testImplementation "org.scala-js:scalajs-junit-test-runtime_$scala2versionSuffix:{version-framework-junit4-scalajs}"
...
dependencies {
  ...
  testScalaCompilerPlugins "org.scala-native:junit-plugin_$scalaVersion:$scalaNativeVersion" // <3>
