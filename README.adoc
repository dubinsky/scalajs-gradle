...
:icons: font
// INCLUDED ATTRIBUTES
:attribute-gradleVersionForBadge: 9.4.0--rc--2
:attribute-pluginBackendProperty: org.podval.tools.backend
:version-gradle: 9.4.0-rc-2
:version-plugin: 0.9.19
