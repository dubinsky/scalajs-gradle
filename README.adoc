...
:icons: font
// INCLUDED ATTRIBUTES
:attribute-gradleVersionForBadge: 9.5.0--rc--2
:attribute-pluginBackendProperty: org.podval.tools.backend
:version-gradle: 9.5.0-rc-2
:version-plugin: 1.0.1
:version-scalanative: 0.5.11
...
:version-framework-junit4-scala-native: 0.5.11
:version-framework-airspec: 2026.1.5
:version-framework-hedgehog: 0.13.0
:version-framework-munit: 1.3.0
...
:version-framework-weaver-test: 0.12.0
:version-framework-ziotest: 2.1.25
// INCLUDED ATTRIBUTES
