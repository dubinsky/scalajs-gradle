...
:icons: font
// INCLUDED ATTRIBUTES
:version-plugin: 0.9.8
:version-gradle: 9.1.0-rc-1
:version-scala: 3.7.2
...
:version-framework-airspec: 2025.1.16
...
:attribute-gradleVersionForBadge: 9.1.0--rc--1
// INCLUDED ATTRIBUTES
...
and https://github.com/He-Pin[He-Pin] for
encouragement.
...
Do not pluralize singular failure.
