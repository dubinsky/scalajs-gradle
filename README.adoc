...
:version-framework-junit4-scalanative: 0.5.9
:version-framework-airspec: 2025.1.27
:version-framework-hedgehog: 0.13.0
:version-framework-munit: 1.2.1
...
:attribute-gradleVersionForBadge: 9.3.0
// INCLUDED ATTRIBUTES
