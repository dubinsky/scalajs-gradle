...
:icons: font
// INCLUDED ATTRIBUTES
:attribute-gradleVersionForBadge: 9.4.0--rc--1
:attribute-pluginScalaProperty: org.podval.tools.backend
:version-gradle: 9.4.0-rc-1
...
:version-framework-junit4-scalajs: 1.20.2
:version-framework-junit4-scalanative: 0.5.10
:version-framework-airspec: 2026.1.1
:version-framework-hedgehog: 0.13.0
:version-framework-munit: 1.2.2
...
:version-framework-weaver: 0.11.3
:version-framework-zio-test: 2.1.24
// INCLUDED ATTRIBUTES
