...
import org.junit.Assert.{assertArrayEquals, assertEquals, assertFalse, assertNotNull, assertNotSame, assertNull,
...
final class JUnit4Test /*AssertTests*/:
  ...
  @Test def testAssertEquals(): Unit =
    assertEquals("failure - strings are not equal", "text", "text")

  @Test def testAssertFalse(): Unit =
    assertFalse("failure - should be false", false)

  @Test def testAssertNotNull(): Unit =
    assertNotNull("should not be null", new Object)

  @Test def testAssertNotSame(): Unit =
    assertNotSame("should not be same Object", new Object, new Object)

  @Test def testAssertNull(): Unit =
  ...
  @Test def testAssertThatBothContainsString(): Unit =
    assertThat("albumen", both(containsString("a")).and(containsString("b")))

  @Test def testAssertThatHasItems(): Unit =
    assertThat(java.util.Arrays.asList("one", "two", "three"), hasItems("one", "three"))

  @Test def testAssertThatEveryItemContainsString(): Unit =
    assertThat(java.util.Arrays.asList("fun", "ban", "net"), everyItem(containsString("n")))
